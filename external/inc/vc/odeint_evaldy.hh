...
struct undefined_result_of<VC::vecn::vecn<D,T>> {
  auto operator()() const {
    static_assert(std::is_floating_point<T>::value, "expect floating point type");
    return VC::vecn::vecn<D,T> {
      //# ifndef NDEBUG -- avoid "undefined" warning
